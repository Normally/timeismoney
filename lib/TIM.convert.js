TIM.convert = (function() {
  ...
  var offsets = {
    ...
    d: {
      ...
      max: TIM.settings.values.workingDays - 2, // Needs to be improved
      total: TIM.settings.values.workingDays
    },
    hr: {
      d: 3600,
      max: TIM.settings.values.workingHours - 2, // could be improved
  ...
  var oneSecondWage = function() {
    return (TIM.settings.values.yearlyWage * (1 - TIM.settings.values.tax)) / (TIM.settings.values.workingDays * 52) / TIM.settings.values.workingHours / 60 / 60;
  };
